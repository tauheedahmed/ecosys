...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmTasksbackup : System.Web.UI.Page
	{
		...
		private void loadData ()
		{
			...
			else if (Session["startForm"].ToString() == "frmMainEPS")
			{
				gridSet1();				
			}
		...
		private void gridSet1()
		{
			...
			{
				Button bClients = (Button)(i.Cells[6].FindControl("btnClients"));
				Button bStaff = (Button)(i.Cells[6].FindControl("btnStaff"));
				Button bPlan = (Button)(i.Cells[6].FindControl("btnPlan"));
				Button bDetails = (Button)(i.Cells[6].FindControl("btnDetails"));
				Button bDelete = (Button)(i.Cells[6].FindControl("btnDelete"));
				bDetails.Visible=false;
				bClients.Text=i.Cells[11].Text;
				bStaff.Text=i.Cells[12].Text;
				if (Session["CallerTasks"].ToString() == "frmLocs")
				{
					lblContents2.Text="Location: " + Session["LocationName"].ToString();
					DataGrid1.Columns[5].HeaderText="Services";
		...
		private void gridSet2()
		{
			...
			foreach (DataGridItem i in DataGrid1.Items)
			{
				Button bReg = (Button)(i.Cells[8].FindControl("btnRegister"));
				bReg.Visible=true;
		...
		private void processCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			else if (e.CommandName == "Plan")
			{
				...
				Session["LocId"]=e.Item.Cells[7].Text;
				Session["StepType"]="na";
			...
			else if (e.CommandName == "Staff")
			{
				...
				Session["TaskName"]=e.Item.Cells[1].Text;
				Session["TaskId"]=e.Item.Cells[0].Text;
				Session["ProcId"]=e.Item.Cells[10].Text;
		...
		{
			Session["CLSProcs"]="frmTasks";
			Response.Redirect(strURL + "frmLocServiceProcs.aspx?");
		}
	}
