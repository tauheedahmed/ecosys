<%@ Page language="c#" Inherits="WebApplication2.frmTaskServices" CodeFile="frmTaskServices.aspx.cs" %>
...
<asp:BoundColumn DataField="ServiceTypeName" HeaderText="Service Type">
...
<asp:BoundColumn Visible="False" DataField="ServicesId" ReadOnly="True"></asp:BoundColumn>
<asp:BoundColumn DataField="ProviderName" HeaderText="Service Provider">
...
<ItemTemplate>
							<asp:TextBox id="txtQty" runat="server" Width="72px" ForeColor="Teal" BorderStyle="Solid" BorderColor="Teal"></asp:TextBox>
							<asp:label id="lblQtyMeasure" runat="server" Width="181px" Height="19px" ForeColor="Navy" Font-Size="Small"></asp:label>
						
</ItemTemplate>
</asp:TemplateColumn>
<asp:TemplateColumn>
<ItemTemplate>
<asp:Button id=Button1 runat="server" ForeColor="White" Font-Size="X-Small" Text="Service Provider" Font-Bold="True" BackColor="Teal" BorderStyle="None" CommandName="ServiceProvider"></asp:Button>
