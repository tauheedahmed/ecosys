<%@ Page language="c#" Inherits="WebApplication2.frmProjectsAll" CodeFile="frmProjectsAll.aspx.cs" %>
		...
		<form id="frmResourcesInfo" method="post" runat="server">
			...
			<asp:label id="lblContent2" style="Z-INDEX: 106; LEFT: 9px; POSITION: absolute; TOP: 53px" runat="server" Width="974px" Height="19px" ForeColor="Navy" Font-Size="Small"></asp:label><asp:button id="btnCancel" style="Z-INDEX: 105; LEFT: 194px; POSITION: absolute; TOP: 108px" runat="server" Font-Size="Smaller" ForeColor="White" Height="40px" Width="134" Font-Bold="True" BackColor="Navy" Text="Cancel" BorderStyle="None" onclick="btnCancel_Click"></asp:button><asp:button id="btnOK" style="Z-INDEX: 104; LEFT: 38px; POSITION: absolute; TOP: 108px" runat="server" Font-Size="Smaller" ForeColor="White" Height="40px" Width="134" Font-Bold="True" BackColor="Navy" Text="OK" BorderStyle="None" onclick="btnOK_Click"></asp:button><asp:label id="lblOrg" style="Z-INDEX: 103; LEFT: 9px; POSITION: absolute; TOP: 8px" runat="server" Font-Size="Small" ForeColor="Navy" Height="17px" Width="914px" Font-Bold="True">Organization Name Here</asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 102; LEFT: 37px; POSITION: absolute; TOP: 155px" runat="server" ForeColor="Maroon" Height="30px" Width="800px" BorderStyle="None" HorizontalAlign="Left" AutoGenerateColumns="False">
				...
				<Columns>
					...
					<asp:BoundColumn HeaderText="Course Provider">
					...
					<asp:BoundColumn Visible="False" DataField="ServiceOrgName" ReadOnly="True"></asp:BoundColumn>
					<asp:BoundColumn Visible="False" DataField="LicOrgId" ReadOnly="True"></asp:BoundColumn>
					<asp:BoundColumn Visible="False" DataField="LicOrgName" ReadOnly="True"></asp:BoundColumn>
