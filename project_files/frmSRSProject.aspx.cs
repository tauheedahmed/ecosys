...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmSRSProject: System.Web.UI.Page
	{
		...
		private void loadData()
		{
			...
			cmd.CommandText="wms_RetrieveSRStaff";		
			...
			if (e.CommandName == "Remove")
				{
					SqlCommand cmd=new SqlCommand();
					cmd.CommandType=CommandType.StoredProcedure;
					cmd.CommandText="wms_DeleteSRStaff";
					cmd.Connection=this.epsDbConn;
		...
		private void updateGrid()
		{
			foreach (DataGridItem i in DataGrid1.Items)
			{
				...
				if (cb.Checked)
				{
					cmd.CommandText="Update StepRStaff"
						+ " Set BkupFlag=1" 
		...
		private void Exit()
		{
			Response.Redirect (strURL + Session["CSRSP"].ToString() + ".aspx?");
		}
