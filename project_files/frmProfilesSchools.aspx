<%@ Page language="c#" Inherits="WebApplication2.frmProfilesSchools" CodeFile="frmProfilesSchools.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="frmResourcesInfo" method="post" runat="server">
			<asp:label id="lblFunction" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 43px" runat="server" Width="748px" Height="30px" ForeColor="Navy" Font-Size="Small"></asp:label><asp:button id="btnCancel" style="Z-INDEX: 105; LEFT: 168px; POSITION: absolute; TOP: 89px" runat="server" Width="134" Height="40px" ForeColor="White" Font-Size="Smaller" BorderStyle="None" Text="Cancel" BackColor="Navy" Font-Bold="True" onclick="btnCancel_Click"></asp:button><asp:button id="btnOK" style="Z-INDEX: 104; LEFT: 12px; POSITION: absolute; TOP: 89px" runat="server" Width="134" Height="40px" ForeColor="White" Font-Size="Smaller" BorderStyle="None" Text="OK" BackColor="Navy" Font-Bold="True" onclick="btnOK_Click"></asp:button><asp:label id="lblOrg" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server" Height="31px" ForeColor="White" Font-Size="Small" BackColor="Navy" Font-Bold="True">Organization Name Here</asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 12px; POSITION: absolute; TOP: 137px" runat="server" Width="550px" Height="30px" ForeColor="Maroon" BorderStyle="None" AutoGenerateColumns="False" HorizontalAlign="Left">
