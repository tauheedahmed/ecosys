<%@ Page language="c#" Inherits="WebApplication2.frmProjCOrgs" CodeFile="frmProjCOrgs.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="frmResourcesInfo" method="post" runat="server">
			<asp:label id="lblContents1" style="Z-INDEX: 101; LEFT: 38px; POSITION: absolute; TOP: 36px" runat="server" Width="962px" Height="20px" ForeColor="Navy" Font-Size="Small"></asp:label><asp:button id="btnAdd" style="Z-INDEX: 107; LEFT: 185px; POSITION: absolute; TOP: 131px" runat="server" Width="135" Height="35px" ForeColor="White" Font-Size="Smaller" Text="Add" Font-Bold="True" BackColor="Navy" BorderStyle="None" onclick="btnAdd_Click"></asp:button><asp:label id="lblContents2" style="Z-INDEX: 105; LEFT: 38px; POSITION: absolute; TOP: 60px" runat="server" Width="974px" Height="19px" ForeColor="Navy" Font-Size="Small"></asp:label><asp:button id="btnOK" style="Z-INDEX: 104; LEFT: 38px; POSITION: absolute; TOP: 131px" runat="server" Width="135" Height="35px" ForeColor="White" Font-Size="Smaller" Text="OK" Font-Bold="True" BackColor="Navy" BorderStyle="None" onclick="btnOK_Click"></asp:button><asp:label id="lblOrg" style="Z-INDEX: 103; LEFT: 38px; POSITION: absolute; TOP: 8px" runat="server" Height="26px" ForeColor="Navy" Font-Size="Small" Font-Bold="True" BackColor="White" DESIGNTIMEDRAGDROP="13"></asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 102; LEFT: 39px; POSITION: absolute; TOP: 168px" runat="server" Height="30px" ForeColor="Maroon" BorderStyle="None" AutoGenerateColumns="False" HorizontalAlign="Left">
				...
				<Columns>
					...
					<asp:BoundColumn Visible="False" DataField="OrgIdClient" ReadOnly="True">
