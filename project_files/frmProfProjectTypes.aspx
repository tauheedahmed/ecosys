<%@ Page language="c#" Inherits="WebApplication2.frmProfProjectTypes" CodeFile="frmProfProjectTypes.aspx.cs" %>
...
<ItemTemplate>
							<asp:button id="Button1" runat="server" Font-Bold="True" BackColor="Teal" Text="Select" BorderStyle="None" Font-Size="Smaller" ForeColor="White" CommandName="Select"></asp:button>
						
</ItemTemplate>
</asp:TemplateColumn>
<asp:TemplateColumn>
<ItemTemplate>
							<asp:button id="btnProcs" runat="server" Font-Bold="True" BackColor="Teal" Text="Processes" BorderStyle="None" Font-Size="Smaller" ForeColor="White" Height="25px" CommandName="Procs"></asp:button>
						
</ItemTemplate>
</asp:TemplateColumn>
<asp:TemplateColumn>
<ItemTemplate>
							<asp:button id="btnRemove" runat="server" Font-Bold="True" BackColor="Maroon" Text="Remove" BorderStyle="None" Font-Size="Smaller" ForeColor="White" Height="25px" CommandName="Remove"></asp:button>
						
</ItemTemplate>
</asp:TemplateColumn>
<asp:BoundColumn Visible="False" DataField="ProjectTypesId" ReadOnly="True"></asp:BoundColumn>
</Columns>
			</asp:datagrid></form>
	</body>
</HTML>
