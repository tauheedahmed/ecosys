...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmUpdLicOrg : System.Web.UI.Page
	{
        ...
        private int GetIndexOfCurrencies(string s)
        {
            return (lstCurrencies.Items.IndexOf(lstCurrencies.Items.FindByValue(s)));
        }
...
{    
		...
		private void loadData()
		{
			...
			rblVis.SelectedIndex = GetIndexOfVisibility (ds.Tables["OO"].Rows[0][6].ToString());
			lstProfile.SelectedIndex = GetIndexProfile (ds.Tables["OO"].Rows[0][7].ToString());
            lstCurrencies.SelectedIndex = GetIndexOfCurrencies(ds.Tables["OO"].Rows[0][9].ToString());
        ...
        private void loadCurrencies()
        {
            ...
            lstCurrencies.DataSource = ds;
            lstCurrencies.DataMember = "Currencies";
            lstCurrencies.DataTextField = "Name";
            lstCurrencies.DataValueField = "Id";
		...
		protected void btnAction_Click(object sender, System.EventArgs e)
		{
			if (btnAction.Text == "Update") 
			{
                ...
                cmd.Parameters["@CurrenciesId"].Value = lstCurrencies.SelectedItem.Value;
			...
			else if (btnAction.Text == "Add")
			{
				...
				cmd1.Parameters["@LicenseId"].Value= Session["ClientLicenseId"];
                ...
                cmd1.Parameters.Add("@CurrenciesId", SqlDbType.Int);
                cmd1.Parameters["@CurrenciesId"].Value = lstCurrencies.SelectedItem.Value;
