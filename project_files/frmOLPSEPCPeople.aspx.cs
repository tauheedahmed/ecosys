...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmOLPSEPCPeople: System.Web.UI.Page
	{
		...
		private void loadData()
		{
			...
			cmd.CommandText="wms_RetrieveOLPCPeople";		
			...
			if (ds.Tables["RoleStaff"].Rows.Count == 0)
			{
				...
				lblContents2.Text="There are no individual clients currently identified for this task."
					+ " Click on 'Add' to add individual clients.";
		...
		private void Exit()
		{
			Response.Redirect (strURL + Session["COLPSEPCP"].ToString() + ".aspx?");
		}
