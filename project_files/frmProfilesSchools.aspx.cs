...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmProfilesSchools: System.Web.UI.Page
	{
		...
		{			
			...
			{	
				lblOrg.Text="";
				lblFunction.Text="Please check all items that are true for you or your school";
				loadData();
			}
		}
		private void loadData()
		{
			...
			cmd.CommandText="eps_RetrieveProfilesOrg";
		...
		private void Exit()
		{
			Response.Redirect (strURL + Session["CPSc"].ToString() + ".aspx?");
		}
