<%@ Page language="c#" Inherits="WebApplication2.frmContracts" CodeFile="frmContracts.aspx.cs" %>
		...
		<form id="frmEmergencyProcedures" method="post" runat="server">
			<asp:datagrid id="DataGrid1" style="Z-INDEX: 100; LEFT: 32px; POSITION: absolute; TOP: 170px" runat="server" Height="30px" BorderColor="White" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="4" AllowSorting="True" ForeColor="#A7D7CC" GridLines="None" AutoGenerateColumns="False">
				...
				<Columns>
					...
					<asp:BoundColumn DataField="LocName" HeaderText="Task Locations"></asp:BoundColumn>
					...
					<asp:BoundColumn DataField="SupplierName" HeaderText="Suppliers"></asp:BoundColumn>
					<asp:BoundColumn DataField="GSName" HeaderText="Goods/Services Provided"></asp:BoundColumn>
