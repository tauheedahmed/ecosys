<%@ Page language="c#" Inherits="WebApplication2.frmEventProcsAll" CodeFile="frmEventProcsAll.aspx.cs" %>
				...
				<Columns>
					...
					<asp:TemplateColumn>
						<ItemTemplate>
							...
							<asp:button id="btnDelete" runat="server" Font-Size="Smaller" ForeColor="White" BorderStyle="None" Text="Delete" BackColor="Maroon" Font-Bold="True" CommandName="Delete"></asp:button>
						</ItemTemplate>
					</asp:TemplateColumn>
