...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmUpdLoc : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				lblContent.Text=btnAction.Text + " Location";	
...
{    
		...
		private void Done()
		{
			Response.Redirect (strURL + Session["CUpdLocs"].ToString() + ".aspx?");
		}
