...
namespace WebApplication2
{
	...
	/// </summary>
	public partial class frmOLPSEPCOrgs: System.Web.UI.Page
	{
		...
		private void loadData()
		{
			...
			cmd.CommandText="wms_RetrieveOLPCOrgs";		
			...
			{
				lblContents2.Text="There are no client organizations currently identified to this task."
					+ " Click on 'Add' to add client organizations.";
		...
		{
			Session["CContracts"]="frmOLPSEPCOrgs";
			...
			if (e.CommandName == "Remove")
				{
					SqlCommand cmd=new SqlCommand();
					cmd.CommandType=CommandType.StoredProcedure;
					cmd.CommandText="wms_DeleteOLPCOrgs";
					cmd.Connection=this.epsDbConn;
		...
		private void Exit()
		{
			Response.Redirect (strURL + Session["COLPSEPCO"].ToString() + ".aspx?");
		}
